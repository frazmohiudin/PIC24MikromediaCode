 ...
 *
 * Hardware platform: PIC24 Mikromedia board
 */
 ...
 * PIC24 clock 
 ********************************************************************/
#define GetSystemClock()            (32000000ull)
...
********************************************************************/
#define GRAPHICS_HARDWARE_PLATFORM  uMPIC24
...
// display type MIO283QT-9A - ILI9341 controller
#define GFX_USE_DISPLAY_CONTROLLER_IL9341

// for older display type MIO283QT2 - HX8347D controller
//#define GFX_USE_DISPLAY_CONTROLLER_HX8347D

// interface - 8-bit PMP interface
#define USE_GFX_PMP
#define USE_8BIT_PMP
